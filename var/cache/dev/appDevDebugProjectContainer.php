...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'gol_api.api' => 'getGolApi_ApiService',
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('5FOENO+MfR', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('s8TnJEkl89', 0, '5tEnCCwi9KCQDyzZyKcRu3', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_7f228950a8b11d786e0d02e2baa1e885a68839a6558ffaca1f5a296ef75658b6');
     ...
     */
    protected function getGolApi_ApiService()
    {
        return $this->services['gol_api.api'] = new \GOL\ApiBundle\Controller\ApiController();
    }
    ...
    {
        return $this->services['property_accessor'] = new \Symfony\Component\PropertyAccess\PropertyAccessor(false, false, \Symfony\Component\PropertyAccess\PropertyAccessor::createCache('gVteUO6Tpq', NULL, '5tEnCCwi9KCQDyzZyKcRu3', $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/GOL/MenuBundle/Resources/views'), 'GOLMenu');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('e39ad986279f4a2f3f5f118ab51f36bd940f9959');
    }
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('l7O7+jEE9f', 0, '5tEnCCwi9KCQDyzZyKcRu3', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('58ab04f78f62e1.06735612')), true);
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'GOLMenuBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/GOL/MenuBundle'),
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'GOLMenuBundle' => 'GOL\\MenuBundle\\GOLMenuBundle',
            ...
            'secret' => 'e39ad986279f4a2f3f5f118ab51f36bd940f9959',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => 'e39ad986279f4a2f3f5f118ab51f36bd940f9959',
